  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="parcourir">Tout Parcourir</a></li>
...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Biking'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>e Biking est un cours de cyclisme en salle qui consiste en l’utilisation de vélos fixes en salle, et en groupe, le tout en musique. Avec un coach sportif, les exercices proposés sont basés sur la résistance cardio-respiratoire et le travail musculaire. Le Biking est tout particulièrement conseillé pour la perte de poids </p>
       
      
      <p>
       N'attendez plus, venez découvrir le Biking et reservez une seance avec notre Coach sportif !</p>
      </div>    
    </div>
