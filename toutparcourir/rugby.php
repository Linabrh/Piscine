...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Rugby'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>Venez découvrir le ballon ovale ! Pratiquer un jeu dynamique de mouvement et d’évitement. Vitesse, contournement, collectif, fair-play, engagement, des qualités et valeurs que porte le Rugby. </p>
