...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Tennis'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>Envie de vous initier ou de vous perfectionner au tennis ? </p>
      
      <p>
       Prenez des maintenant, un rendez vous avec notre coach !</p>
      </div>    
    </div>
