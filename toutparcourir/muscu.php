  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Salle de Sport Omnes <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="nesservices.php">Nos Services</a></li>
...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Musculation'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>La musculation est un sport individuel ou collectif que vous pouvez pratiquer dans votre salle de sport Omnes Sports. </p>
       <p>La musculation est une activite physique qui vous permet d’augmenter votre masse musculaire. Grace a des exercices de musculation varies, vous pouvez ameliorer votre condition physique de maniere homogene : du haut du corps jusqu’au bas du corps.</p>
      <p>La musculation consiste à travailler chaque groupe musculaire : pectoraux, biceps, triceps, quadriceps, etc.</p>
