...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Cardio-Training'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>Chez Omnes Sports, nous avons choisi le meilleur équipement pour vous offrir un espace de cardio training au top ! Vélos, vélos semi-allongés, steppers, rameurs, tapis de course, elliptiques, toutes les machines que vous utilisez sont faciles d’utilisation, efficaces et de grande qualité. </p>
       <p>En faisant un travail Cardio, vous améliorez votre endurance, votre condition physique et vous perdez du poids. Le travail cardio est essentiel pour un corps bien portant : diminution des risques de maladies cardiovasculaires, régulation du poids, amélioration des fonctions respiratoires…</p>
      
      <p>
       Et pour mieux optimiser vos efforts, contactez notre coach de la forme qui vous accompagnera pour élaborer un programme qui vous aidera à atteindre vos objectifs !</p>
      </div>    
    </div>
