...
<div class="container ">    
  ...
  <div class="container col-sm-6 ">  
      ...
      <div class="well">
         <h2 class="text-center"> Activités Sportives </h2><br><br>
       <p>Vous etes membre de l'Omnes Sports ? </p>
       <p>N'attendez plus, participez aux nombreuses activités sportives que nous vous proposons !
       Parmis ces activite on retrouve :</p>
       <ul>
       <li>La Musculation</li>
      <li>Le Fitness</li>
      <li>Le Biking</li>
       <li>Le Cardio-Training</li>
       <li>Les Cours Collectifs</li>
        </ul>
        <p>  Selectionnez donc une activité, et decouvrez tout nos différents caochs specialistes !</p>     
  ...
  <div class="container col-sm-6 ">  
      ...
      <div class="well">
         <h2 class="text-center"> Sports de Compétition </h2><br><br>
       <p>Vous etes membre de l'Omnes Sports ? </p>
       <p>N'attendez plus, participez aux nombreuses activités sportives que nous vous proposons !
       Parmis ces activite on retrouve :</p>
       <ul>
