...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Cours Collectifs'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>Les cours collectifs d'Omnes Sports regroupent plusieurs formats d’activités et différentes méthodes d’exercices. Chacun d’entre eux permet d’atteindre des objectifs différents. Dépense calorique, perte de poids, musculation, force, endurance, tonicité du corps… Tu trouveras toujours un cours qui permet de répondre à ton besoin. </p>
       <p>Ces cours sont animés par un coach, que tu peut contacter des maintement !</p>
