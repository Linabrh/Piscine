...
<?php
 ...
 $database = "sport";
  ...
  if ($db_found) {
  $sql = "SELECT * FROM coach WHERE Sport = 'Fitness'";
...
<div class="container ">    
  ...
  <div class="col-sm-4">
      <div class="well">
       <p>Par ses multiples disciplines sportives, le fitness renforce votre cœur par ses exercices cardio-training et développe votre capacité respiratoire afin d’éviter les maladies cardio-vasculaires. La pratique du fitness vous aide à rester en forme en activant votre circulation sanguine, apporte une amélioration visuelle à votre peau. </p>
       <p>Votre corps complet se tonifie avec un renforcement musculaire du corps dont vos abdos, est assuré sans oublier l’obtention d’une souplesse à votre corps. La pratique régulière de cours de fitness est une des meilleures expériences sportives pour perdre du poids tout en prenant du plaisir.</p> 
      <p>
       N'attendez plus et reservez une seance avec notre Coach sportif !</p>
