...
$_SESSION['name'] . "</b> a quitté la session de chat.</span><br></div>";
$myfile = fopen(__DIR__ . "/log.html", "a") or die("Impossible d'ouvrir le fichier!" . __DIR__ . "/log.html"); fwrite($myfile, $logout_message);
fclose($myfile);
session_destroy();
sleep(1);
...
'<div id="loginform">
<p>Veuillez saisir votre nom pour continuer!</p> <form action="chat.php" method="post">
<label for="name">Nom: </label>
<input type="text" class="form-control" name="name" id="name" /><br>
<input type="submit" class="btn btn-danger" name="enter" id="enter" value="Soumettre" />
</form>
</div>'; }
?>
...
<p class="logout"><a id="exit" href="#">Quitter la conversation</a></p> </div>
<div id="chatbox">
...
var clientmsg = $("#usermsg").val(); $.post("post.php", { text: clientmsg }); $("#usermsg").val("");
return false;
});
function loadLog() {
var oldscrollHeight = $("#chatbox")[0].scrollHeight - 20; //Hauteur de défilement avant la requête
$.ajax({
url: "log.html",
cache: false,
success: function (html) {
$("#chatbox").html(html); //Insérez le log de chat dans la #chatbox div
//Auto-scroll
var newscrollHeight = $("#chatbox")[0].scrollHeight - 20; //Hauteur de défilement apres la requête if(newscrollHeight > oldscrollHeight){
$("#chatbox").animate({ scrollTop: newscrollHeight }, 'normal'); //Défilement automatique }
} });
}
setInterval (loadLog, 2500); $("#exit").click(function () {
var exit = confirm("Voulez-vous vraiment mettre fin à la session ?"); if (exit == true) {
...
?>
    ...
    <div class="col-sm-8">  
      <div class="well">
        ...
        <h3> Envoyer un mail à nos coachs :</h3>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name=contenu rows="5" id="comment"></textarea>
        </div>
      ...
      <div class="well">
        ...
        <h4> Visio :</h4>
        <p> Cliquez sur ce liens pour être en visio conference avec l'un de nos coach </p>
