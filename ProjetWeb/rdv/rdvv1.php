  ...
  <div class="col-sm-8">
    ...
    <tbody>
      ...
      <tr>
       ...
       ?>
       <?php 
        if((strcmp($jours,$jour5)==0)&&(strcmp($heures, $h2)==0)) {
           echo '<td class="text-center" style="background-color:BLACK"> </td>';  }
        else{
